package com.example.shoppingappandroid;
...
import com.example.shoppingappandroid.Prevalent.Prevalent;
...
public class ResetPasswordActivity extends AppCompatActivity {
    ...
    private TextView pageTitle, titleQuetions;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleQuetions = findViewById(R.id.title_quetions);
    ...
    protected void onStart() {
        ...
        if (check.equals("settings")) {
            ...
            titleQuetions.setText("Please set answer for the following security Quetions :");
    ...
    private void setAnswers() {
        ...
        if (question1.equals("") && question2.equals("")) {
            ...
            ref.child("Security Quetions").updateChildren(userdataMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                @Override
    ...
    private void displayPreviousAnswers() {
        ...
        ref.child("Security Quetions").addValueEventListener(new ValueEventListener() {
            @Override
            ...
            ref.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists()) {
                        ...
                        if (dataSnapshot.hasChild("Security Quetions")) {
                            String ans1 = dataSnapshot.child("Security Quetions").child("answer1").getValue().toString();
                            String ans2 = dataSnapshot.child("Security Quetions").child("answer2").getValue().toString();
