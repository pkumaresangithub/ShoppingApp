...
public class SettinsActivity extends AppCompatActivity {
    ...
    private Button securityQuetionBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        securityQuetionBtn = findViewById(R.id.security_quetions_btn);
        ...
        securityQuetionBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
